...
def favorite_restaurant():
    ...
    #    }
    favorite_restaurant["name"] = input("Favorite Restaurants: ")
    favorite_restaurant["address"] = input("Enter the Address: ")
    favorite_restaurant["favorite_dish"] = input("Favorite Dish: ")
...
def clean_print():
    ...
    for pair in restaurant_1: 
        print(f"{pair}: {restaurant_1[pair]}")
